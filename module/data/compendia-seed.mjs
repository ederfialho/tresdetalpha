...
export const VANTAGENS = [
  {
    ...
    categoria: "Movimento",
    mode: "activatable",
    activation: { custoPMsAtivacao: 1, custoPMsPorTurno: 0 },
  ...
  },
  {
    ...
    categoria: "Combate",
    mode: "activatable",
    activation: { custoPMsAtivacao: 2, custoPMsPorTurno: 2 },
  ...
  },
  {
    ...
    categoria: "Combate",
    mode: "reaction",
    activation: { custoPMsAtivacao: 2, custoPMsPorTurno: 0 },
  ...
  },
  {
    ...
    categoria: "Perícia",
    mode: "activatable",
    activation: { custoPMsAtivacao: 0, custoPMsPorTurno: 0 },
  ...
  },
  {
    ...
    categoria: "Combate",
    mode: "activatable",
    activation: { custoPMsAtivacao: 0, custoPMsPorTurno: 1 },
  ...
  },
  {
    ...
    effects: [effPermanent("Resistência à Magia — R+2 contra magia", [chg("system.abilities.resistencia.bonus", 2)])]
  },
  {
  ...
  },
  {
    ...
    categoria: "Combate",
    mode: "activatable",
    activation: { custoPMsAtivacao: 4, custoPMsPorTurno: 0 },
  ...
  /* Sentidos específicos — tratados como vantagens independentes pra servir de
     "granted" em pacotes raciais (Anão → Infravisão; Kemono escolhe 2 de 3; etc). */
  {
    name: "Infravisão", custo: 1,
    categoria: "Sentidos",
    mode: "passive",
    efeito: "<p>Enxerga perfeitamente no escuro. Variante de Sentidos Especiais focada em visão termal/luz residual, comum em seres subterrâneos (anões, goblins, elfos negros, trogloditas).</p>"
  },
  {
    name: "Visão Aguçada", custo: 1,
    categoria: "Sentidos",
    mode: "passive",
    efeito: "<p>Enxerga detalhes a longas distâncias. +1 em testes de Habilidade ligados a observar ou identificar algo distante.</p>"
  },
  {
    name: "Faro Aguçado", custo: 1,
    categoria: "Sentidos",
    mode: "passive",
    efeito: "<p>Olfato apurado capaz de rastrear pessoas e identificar substâncias pelo cheiro. +1 em testes ligados a rastreamento ou identificação por odor.</p>"
  },
  {
    name: "Audição Aguçada", custo: 1,
    categoria: "Sentidos",
    mode: "passive",
    efeito: "<p>Audição apurada capaz de notar sussurros e sons abafados. +1 em testes de Habilidade para escutar ou identificar sons.</p>"
  },

  /* Mobilidade aquática — granted por Anfíbio e similares. */
  {
    name: "Natação", custo: 1,
    categoria: "Movimento",
    mode: "passive",
    efeito: "<p>Move-se na água tão bem quanto em terra firme (sem penalidades de velocidade ou combate). Pode respirar submerso em ambientes aquáticos naturais.</p>"
  },

  /* Mudança de aparência — granted por Nanomorfo. */
  {
    name: "Doppelganger", custo: 2,
    categoria: "Subterfúgio",
    mode: "activatable",
    activation: { custoPMsAtivacao: 1, custoPMsPorTurno: 0 },
    efeito: "<p>Pode assumir a aparência de qualquer criatura humanoide de tamanho aproximado. Copia voz e traços; não ganha memórias nem poderes do original. Um teste de H (−1) pode revelar o disfarce a quem conhece bem o alvo.</p>"
  }
];
...
export const DESVANTAGENS = [
  ...
  /* Desvantagens granted por pacotes raciais — referenciadas por Elfo Negro (Ponto Fraco),
     Minotauro/Vampiro (Fobia), Anfíbio/Youkai/Troglodita (Vulnerabilidade) etc. */
  {
    name: "Ponto Fraco", custo: 1,
    categoria: "Física",
    mode: "conditional",
    efeito: "<p>Existe uma condição específica que anula ou reduz drasticamente seus poderes. Exemplos: luz do dia (elfos negros, vampiros), água corrente, prata, símbolos religiosos, presença de um artefato. Quando exposto ao ponto fraco, sofre −1 em todas as características (ou 2× custo em PMs para magias).</p>"
  },
  {
  ...
  },
  {
    ...
    categoria: "Mental",
    mode: "conditional",
    efeito: "<p>Medo terrível de algo. Exposto, precisa fazer teste de R; se falhar, apavorado e foge em velocidade máxima (igual magia Pânico). Valor: <strong>−1 pt</strong> (incomum, ~25% do tempo — altura, insetos, sangue), <strong>−2 pts</strong> (comum, ~50% — escuridão, animais, lugares fechados), <strong>−3 pts</strong> (quase sempre — pessoas, veículos, barulhos altos).</p>"
  }
];
